...
<div class="row-fluid add-new">
  <a href="{{url('/admin/roles/add')}}" class="btn btn-info fa fa-plus">  Nova Permissão </a>
</div>
  ...
  <div class="box span12">
    ...
    <div class="box-content" style="display: {{$isFilter? ' ' : 'none'}}">
        <div class="form-group">
              {!! Form::open(array('method' => 'get', 'url' => '/admin/roles/', 'class' => 'form-horizontal')); !!}
...
<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="icon-align-justify"></i><span class="break"></span>Permissões</h2>
			<div class="box-icon">
				<a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
				<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
				<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
        ...
        @foreach($roles as $role)
				<tr>
					...
					<td class="center">
						<a class="btn btn-success" href="{{url('/admin/roles/view/'.$role->id)}}" title="vizualizar">
							<i class="halflings-icon white zoom-in"></i>
						</a>
						<a class="btn btn-info" href="{{url('/admin/roles/edit/'.$role->id)}}"  title="editar">
							<i class="halflings-icon white edit"></i>
						</a>
						<a class="btn btn-danger" onclick="onDelete({{$role->id}})"  title="excluir">
