			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span> Editar role </h2>
						<div class="box-icon">
					...
					<div class="box-content">
							  {!! Form::model($role, array('method' => 'put', 'class' => 'form-admin', 'url' => '/admin/roles/update/' . $role->id, 'id' => 'EditroleForm')) !!}
						  <fieldset>
