			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span> Editar issue </h2>
						<div class="box-icon">
					...
					<div class="box-content">
							  {!! Form::model($issue, array('method' => 'put', 'class' => 'form-admin', 'url' => '/admin/issues/update/' . $issue->id, 'id' => 'EditissueForm')) !!}
						  <fieldset>
							<div class="control-group">
					          <label class="control-label" for="name"> Título </label>
    							  <div class="controls">
    		                 {{ Form::text('title', null, ['class' => 'span12']) }}
