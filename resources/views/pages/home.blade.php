                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Saiba como ajudaremos sua empresa a expandir seu negócio</h1>
                ...
                <div class="features">
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h2>Dê sua sugestão</h2>
                            <h3> Sua opinião é importante na melhora do atendimento</h3>
                        </div>
                    </div><!--/.col-md-4-->
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                            ...
                            <h2>Fale conosco</h2>
                            <h3>Basta clicar na aba contatos, e enviar seu email.</h3>
                        </div>
                    </div><!--/.col-md-4-->
                            ...
                            <div class="parrent media-body">
                                <div class="tab-content">
                                    <div class="tab-pane fade" id="tab1">
                                        <div class="media">
                                           <div class="pull-left">
                                                <img class="img-responsive" src="{{asset('assets/files/images/tab2.png')}}">
                                            </div>
                                            <div class="media-body">
                                                 <h2>Adipisicing elit</h2>
                                     ...
                                     <div class="tab-pane fade active in" id="tab2">
                                        <div class="media">
                                           <div class="pull-left">
                                                <img class="img-responsive" src="{{asset('assets/files/images/tab1.png')}}">
                                            </div>
                                            <div class="media-body">
                                                 <h2>Adipisicing elit</h2>
